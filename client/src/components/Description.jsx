         ...
         <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
            ...
            <div>
               ...
               <p className="text-gray-600 mb-4">
                  ...
                  images with just a few clicks. Imagine it, describe it, and
               ...
               <p className="text-gray-600 mb-4">
                  ...
                  yet exist can be visualized effortlessly. Powered by advanced
                  AI technology, the creative posibilities are limitless!
               </p>
            </div>
         </div>
      </motion.div>
